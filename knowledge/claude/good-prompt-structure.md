...
## 1. Idea: Talk to Claude Like a Coworker（把 Claude 當同事）
Prompt the way you'd brief a coworker — **naturally, concisely, conversationally** — not
by keyword-stuffing a search box. Before a conversation, run a three-part checklist:
