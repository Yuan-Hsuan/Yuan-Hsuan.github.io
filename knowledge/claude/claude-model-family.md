...
## 1. Idea: One Family, Three Tiers
Claude ships as a family of models that trade **intelligence against cost and latency**.
...
| **Cost per MTok, USD (in / out)** | 5 / 25 — high | 3 / 15 — medium | 1 / 5 — low |
...
| **Best used for** | Advanced software development, especially large-scale architecting · long-running tasks that require sustained focus · strategic planning with multi-step problem solving | Common coding tasks · document creation and editing · data analysis and visualization · image analysis · process automation | **real-time user interaction and high-volume text processing** |
